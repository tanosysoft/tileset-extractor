...
module.exports = (img, options = {}) =>
  new Promise((res, rej) => {
    ...
    let hashesPerFrame = options.hashesPerFrame || 4;
    ...
    requestAnimationFrame(function frame() {
      try {
        ...
        for (let j = 0; j < hashesPerFrame; ++j) {
...
},{"spark-md5":5}],2:[function(require,module,exports){
...
},{"./analyze":1,"./imgFromUrl":2,"./makeItRain":4,"./selectFile":7}],4:[function(require,module,exports){
module.exports = {
